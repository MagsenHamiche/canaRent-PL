...
import { updateUserStart, updateUserSuccess, updateUserFailure, deleteUserStart, deleteUserSuccess, deleteUserFailure, signOutUserStart, signInFailure, signOutUserSuccess }  from '../redux/user/userSlice'
...
export  default function Profile() {
  ...
  return (
    <div className='flex flex-row justify-around ml-3'>
      <div className='p-3 flex flex-col w-96 mx-auto felx-1'>
        ...
        <form onSubmit={handleSumbit} className='flex flex-col gap-4'>
          ...
          <input type="text" placeholder='username' className='border p-3 rounded-lg' 
            id='username' defaultValue={currentUser.username} onChange={handleChange}/>
          <input type="email" placeholder='email' className='border p-3 rounded-lg' 
            id='email' defaultValue={currentUser.email} onChange={handleChange}/>
